...
demo_J = pd.read_sas('https://wwwn.cdc.gov/NCHS/Data/nhanes/Public/2017/DataFiles/DEMO_J.xpt', format='xport', encoding='utf-8')
iff_1_J = pd.read_sas('https://wwwn.cdc.gov/NCHS/Data/nhanes/Public/2017/DataFiles/DR1IFF_J.xpt', format='xport', encoding='utf-8')
iff_2_J = pd.read_sas('https://wwwn.cdc.gov/NCHS/Data/nhanes/Public/2017/DataFiles/DR2IFF_J.xpt', format='xport', encoding='utf-8')
food_desc_J = pd.read_sas('https://wwwn.cdc.gov/NCHS/Data/nhanes/Public/2017/DataFiles/drxfcd_j.xpt', format='xport', encoding='utf-8')
